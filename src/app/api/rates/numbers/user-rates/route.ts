...
interface RateDeckFilter {
  rateDeckId: mongoose.Types.ObjectId | { $in: mongoose.Types.ObjectId[] };
}
...
export async function GET(request: NextRequest) {
  try {
    ...
    let rateDeckFilter: RateDeckFilter = { rateDeckId: { $in: assignedRateDeckIds } };
