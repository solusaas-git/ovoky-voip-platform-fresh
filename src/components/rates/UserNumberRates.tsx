      ...
      <div className="min-h-[400px] flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">{t('rates.numberRates.userRates.description')}</p>
          </div>
        </div>
      </div>
    );
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center space-x-3">
            ...
            <div>
              <CardTitle>{t('rates.numberRates.userRates.noAssignment')}</CardTitle>
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground mb-4">
            {t('rates.numberRates.userRates.description')}
          </p>
          <Button 
            variant="outline" 
            onClick={() => fetchUserRates()}
  ...
  return (
    <div className="space-y-6">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            >
              ...
              {t('rates.numberRates.userRates.title')}
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">{t('rates.numberRates.stats.totalRates')}</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">{t('rates.callRates.stats.rateRange')}</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      {showFilters && (
        <Card>
          <CardHeader>
            <CardTitle className="text-base">{t('rates.common.filters.title')}</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>{t('rates.numberRates.userRates.title')}</CardTitle>
          <CardDescription>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-right">{t('rates.callRates.table.headers.rate')}</TableHead>
                  <TableHead>{t('rates.numberRates.table.headers.currency')}</TableHead>
                  <TableHead>{t('rates.numberRates.userRates.assignedDeck')}</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {rateData?.rates.map((rate) => (
