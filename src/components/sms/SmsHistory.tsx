        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Your SMS sending history ({total.toLocaleString()} messages sent)
              </CardDescription>
            </div>
                ...
                {loading ? (
                  ...
                  messages.map((message) => (
                    <TableRow key={message._id}>
                      ...
                      <TableCell>
                        {message.messageType === 'campaign' ? (
                          <Badge variant="secondary" className="w-fit max-w-32" title={message.campaignName || 'Campaign'}>
                            <span className="truncate">
                              {message.campaignName ? `Campaign: ${message.campaignName}` : 'Campaign'}
                            </span>
                          </Badge>
                        ) : (
                      ...
                      <TableCell className="font-mono">
                        ${(['failed', 'undelivered'].includes(message.status) ? 0 : message.cost).toFixed(4)}
                      </TableCell>
                      <TableCell>
                        <Dialog>
                          ...
                          <DialogContent className="max-w-2xl max-h-[80vh]">
                            ...
                            <ScrollArea className="max-h-[60vh]">
                              <div className="space-y-4">
                                  ...
                                  <div>
                                    ...
                                    <div className="p-2">
                                      {message.messageType === 'campaign' ? (
                                        ...
                                        <Badge variant="outline">Single SMS</Badge>
                                      )}
                                    </div>
                                  </div>
                                  <div>
                                ...
                                {message.messageType === 'campaign' && message.campaignName && (
                                  <div>
